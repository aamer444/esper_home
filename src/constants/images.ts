...
export const images = {
  home: {
    hero: {
      src: "src/assets/images/Industrial_radiators.png",
      fallback: "src/assets/images/Industrial_radiators.png",
    },
    quickActions: {
      products: {
        src: "src/assets/images/product_redirection.png",
        fallback:
  ...
  categories: {
    automotive: {
      src: "src/assets/images/radiator_aluminiume.jpeg",
      fallback:
    ...
    heatExchangers: {
      src: "src/assets/images/right_side_image.png",
      fallback:
  ...
  clients: {
    ...
    service:
      "https://images.unsplash.com/photo-1625047509248-ec889cbff817?w=1400&q=85&auto=format&fit=crop",
  },
} as const;

export const getAssetImage = (asset: ImageAsset): string => asset.src;

export const getAssetFallback = (asset: ImageAsset): string | undefined =>
  asset.fallback;

export const getHeroImage = () => images.home.hero.src;

export const getHeroFallback = () => images.home.hero.fallback;
